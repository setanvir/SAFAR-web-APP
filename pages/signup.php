    ...
    if (empty($name) || empty($email) || empty($password)) {
        ...
        if ($stmt->fetch()) {
            ...
            try {
                ...
                $pdo->commit();
                $success = "Registration successful! You can now <a href='" . BASE_URL . "/pages/login.php'>log in</a>.";
            } catch (Exception $e) {
                $pdo->rollBack();
...
<div class="container my-4">
    <div class="auth-form">
        ...
        <?php endif; ?>
        <p class="text-center mt-2">Already have an account? <a href="<?php echo BASE_URL; ?>/pages/login.php" style="color: var(--primary);">Log in here</a></p>
    </div>
</div>
